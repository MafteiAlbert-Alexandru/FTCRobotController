...
public class SmartServo implements ServoEx {
    ...
    public SmartServo(HardwareMap hw, String servoName, double minAngle, double maxAngle, AngleUnit angleUnit) {
    ...
    public SmartServo(HardwareMap hw, String servoName, double minDegree, double maxDegree) {
    ...
    public double getAngleFromPos(Double pos) {
        return pos * getAngleRange(AngleUnit.DEGREES) + fromRadians(minAngle, AngleUnit.DEGREES);
    }
